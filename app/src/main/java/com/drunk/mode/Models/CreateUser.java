...
public class CreateUser
{
    ...
    public CreateUser(String name, String email, String password, String date, String circlecode, String userid, String issharing, String lat, String lng,String profile_image, String uid) {
        this.name = name;
        this.email = email;
