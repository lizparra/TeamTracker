...
import com.drunk.mode.Activities.LiveMapActivity;
import com.drunk.mode.Adapters.MembersAdapter;
            ...
            public void onDataChange(DataSnapshot dataSnapshot) {
                ...
                if(dataSnapshot.exists())
                {
                    ...
                    for(DataSnapshot dss: dataSnapshot.getChildren())
                    {
                        ...
                        usersReference.child(memberUserId).addValueEventListener(new ValueEventListener() {
                            @Override
                            public void onDataChange(DataSnapshot dataSnapshot) {
